...
document.getElementById('submit').innerText='Submit';
  ...
  document.getElementById('submit').onclick = (event) => {
    ...
    { window.document.location = '/';}};document.getElementById('i7rd').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/';}};document.getElementById('ivg8u').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/assess/';}};document.getElementById('it8tt').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/history/';}};document.getElementById('ii4xs').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/upload/';}};document.getElementById('idvzt').onclick = (event) => {
    event.preventDefault();
