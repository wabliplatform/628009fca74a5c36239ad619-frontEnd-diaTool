...
function readlocalstorage(){
  ...
  document.getElementById('footer').style.setProperty('position','relative','important');
    ...
    { window.document.location = '/';}};document.getElementById('izxo').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/';}};document.getElementById('itked').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/assess/';}};document.getElementById('i5z9m').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/history/';}};document.getElementById('ijxfk').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/upload/';}};document.getElementById('i04p6').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/upload/';}};window.onload = () => {};