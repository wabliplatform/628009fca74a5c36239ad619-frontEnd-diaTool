...
function writedata(inputdata){
  if (localStorage.getItem('records')===null){
    ...
    { window.document.location = '/';}};document.getElementById('iwpg').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/';}};document.getElementById('iszlx').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/assess/';}};document.getElementById('i80i7').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/history/';}};document.getElementById('iuxzo').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/upload/';}};document.getElementById('issvr').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '/upload/';}};document.getElementById('i6pnoz').onclick = (event) => {
    event.preventDefault();
